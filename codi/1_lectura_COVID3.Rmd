...
##########################################################################################################
dt_01<-dt_01 %>%rename(PATIENT.ID	=IDINGRESO)
dt_01<-dt_01 %>%rename(EDAD.AGE=	EDAD)
dt_01<-dt_01 %>%rename(SEXO.SEX	=SEX)
dt_01<-dt_01 %>%rename(DIAG.ING.INPAT	=DIAGNOSTICO_ING)
dt_01<-dt_01 %>%rename(F_INGRESO.ADMISSION_D_ING.INPAT=	F_INGRESO_ING)
dt_01<-dt_01 %>%rename(F_ENTRADA_UC.ICU_DATE_IN=	F_UCI_IN)
dt_01<-dt_01 %>%rename(F_SALIDA_UCI.ICU_DATE_OUT	=F_UCI_OUT)
dt_01<-dt_01 %>%rename(UCI_DIAS.ICU_DAYS	=UCI_DAYS)
dt_01<-dt_01 %>%rename(F_ALTA.DISCHARGE_DATE_ING=	F_ALTA_ING)
dt_01<-dt_01 %>%rename(MOTIVO_ALTA.DESTINY_DISCHARGE_ING=	MOTIVO_ALTA_ING)
dt_01<-dt_01 %>%rename(F_INGRESO.ADMISSION_DATE_URG.EMERG=	F_INGRESO_URG)
dt_01<-dt_01 %>%rename(HORA.TIME_ADMISION.ADMISSION_URG.EMERG=	HORA_URG)
dt_01<-dt_01 %>%rename(ESPECIALIDAD.DEPARTMENT_URG.EMERG	=ESPECIALIDAD_URGENCIA)
dt_01<-dt_01 %>%rename(DIAG_URG.EMERG	=DIAG_URG)
dt_01<-dt_01 %>%rename(DESTINO.DESTINY_URG.EMERG=	DESTINO_URG)
dt_01<-dt_01 %>%rename(HORA.TIME_CONSTANT_PRIMERA.FIRST_URG.EMERG=	HORA_CONSTANTES_PRIMERA_URG)
dt_01<-dt_01 %>%rename(TEMP_PRIMERA.FIRST_URG.EMERG	=TEMP_PRIMERA_URG)
dt_01<-dt_01 %>%rename(FC.HR_PRIMERA.FIRST_URG.EMERG=	FC_PRIMERA_URG)
dt_01<-dt_01 %>%rename(GLU_PRIMERA.FIRST_URG.EMERG	=GLU_PRIMERA_URG)
dt_01<-dt_01 %>%rename(SAT_02_PRIMERA.FIRST_URG.EMERG=	SAT_02_PRIMERA_URG)
dt_01<-dt_01 %>%rename(TA_MAX_PRIMERA.FIRST.EMERG_URG	=TA_MAX_PRIMERA_URG)
dt_01<-dt_01 %>%rename(TA_MIN_PRIMERA.FIRST_URG.EMERG	=TA_MIN_PRIMERA_URG)
dt_01<-dt_01 %>%rename(HORA.TIME_CONSTANT_ULTIMA.LAST_URG.EMERG=	HORA_CONSTANTES_ULTIMA_URG)
dt_01<-dt_01 %>%rename(FC.HR_ULTIMA.LAST_URG.EMERG	=FC_ULTIMA_URG)
dt_01<-dt_01 %>%rename(TEMP_ULTIMA.LAST_URG.EMERG	=TEMP_ULTIMA_URG)
dt_01<-dt_01 %>%rename(GLU_ULTIMA.LAST_URG.EMERG	=GLU_ULTIMA_URG)
dt_01<-dt_01 %>%rename(SAT_02_ULTIMA.LAST_URG.EMERG=	SAT_02_ULTIMA_URG)
dt_01<-dt_01 %>%rename(TA_MAX_ULTIMA.LAST_URGEMERG	=TA_MAX_ULTIMA_URG)
dt_01<-dt_01 %>%rename(TA_MIN_ULTIMA.LAST_URG.EMERG	=TA_MIN_ULTIMA_URG)
...
dt_04 <- read.csv(here::here(directori_dades,"04.csv"), header = TRUE, sep = ",",fileEncoding = "UTF-16",stringsAsFactors=F)%>% as_tibble()
...
dt_05<-dt_05 %>%rename(PATIENT.ID=IDINGRESO)




dt_06<-data.table::fread(here::here(directori_dades,"06.txt"))%>%as_tibble()
dt_06<-dt_06 %>%rename(PATIENT.ID=IDINGRESO)
...
write.csv(CODIS, file="././output/CODIS_2021.csv")
...
#dt_plana_covid3_TEMP$valor<- as.double(dt_plana_covid3_TEMP$valor)
...
#i)
problemas_salut1<-dt_diagnostics%>%select(cod)%>%group_by(cod)%>%dplyr::slice(1)%>%ungroup()
############################################################################################
#ii)
problemas_salut2<-dt_plana_covid2%>%select(ID_ATC5,ATC5_NOMBRE.NAME)%>%group_by(ID_ATC5)%>%dplyr::slice(1)%>%ungroup()
############################################################################################
#iii)
problemas_salut3<-dt_plana_covid2%>%select(ID_ATC7,ATC7_NOMBRE.NAME)%>%group_by(ID_ATC7)%>%dplyr::slice(1)%>%ungroup()
############################################################################################

write.csv(problemas_salut1, file="././output/Problemas_salut_2021.csv")
write.csv(problemas_salut2, file="././output/FARMACS_ATC5_2021.csv")
write.csv(problemas_salut3, file="././output/FARMACS_ATC7_2021.csv")
