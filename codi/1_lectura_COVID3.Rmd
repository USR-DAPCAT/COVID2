...
############################################################################################
#ii)
problemas_salut2<-dt_plana_covid2%>%select(ID_ATC5)%>%group_by(ID_ATC5)%>%dplyr::slice(1)%>%ungroup()
############################################################################################
#iii)
problemas_salut3<-dt_plana_covid2%>%select(ID_ATC7)%>%group_by(ID_ATC7)%>%dplyr::slice(1)%>%ungroup()
############################################################################################
