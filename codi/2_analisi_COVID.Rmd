...
M3_Exitus<-glm(Death2 ~ G_DIABETIC + SEXO.SEX + EDAD.AGE + DG2.OB + DG2.HTA + DG2.Hyperlip + DG2.COMP_CARDIOVASC + DG2.INSUF_CARD + DG.IRC + DG.EPOC_ENFISEMA+G_DIABETIC*DG2.OB,data = TAULA_PLANA_exc, family = "binomial") 

M4_VM<- glm(Death_DG.Mechanical_ventialtion=='Si' ~ G_DIABETIC + SEXO.SEX + EDAD.AGE + DG2.OB + DG2.HTA + DG2.Hyperlip + DG2.COMP_CARDIOVASC + DG2.INSUF_CARD + DG.IRC + DG.EPOC_ENFISEMA+ G_DIABETIC*DG2.OB,data = TAULA_PLANA_exc, family = "binomial") 
