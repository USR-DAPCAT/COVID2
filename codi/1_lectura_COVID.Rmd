...
#  mutate_at(vars(starts_with("EV1.") ),funs(ifelse(is.na(.),"No","Si")))%>%
#  mutate(PATIENT.ID=idp)%>% select(-idp)

#dt_plana_covid_INGRES_agr$Neurologic_Comp <-
#  ifelse(dt_plana_covid_INGRES_agr$EV1.COMP_NEURO=="Si" |
#         dt_plana_covid_INGRES_agr$EV1.ENCEFALITIS=="Si" ,"Si","No")

#dt_plana_covid_INGRES_agr2<-dt_plana_covid_INGRES_agr2 %>%
#  mutate_at(vars(starts_with("EV2.") ),funs(ifelse(is.na(.),"No","Si")))%>%
#  mutate(PATIENT.ID=idp)%>% select(-idp)

#dt_plana_covid_INGRES_agr3<-dt_plana_covid_INGRES_agr3 %>%
#  mutate_at(vars(starts_with("EV3.") ),funs(ifelse(is.na(.),"No","Si")))%>%
#  mutate(PATIENT.ID=idp)%>% select(-idp)
...
#dt_plana_covid_INGRES_agr<-dt_plana_covid_INGRES_agr%>%
#  mutate_at(vars(starts_with("EV") ),funs(ifelse(is.na(.),"No",.)))

#view(dt_plana_covid_INGRES_agr)
