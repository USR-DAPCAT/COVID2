...
dt_01<-read.csv2(here::here(directori_dades,"01.csv"),sep=";",dec=",",header = TRUE,
...
dt_02<-read.csv2(here::here(directori_dades,"02.csv"),sep=";",dec=",",header = TRUE,
                 stringsAsFactors=F) %>% as_tibble()
#-------------------------------------------------------------------------#
...
dt_03<-read.csv2(here::here(directori_dades,"03.csv"),sep=";",dec=",",header = TRUE,
                 stringsAsFactors=F) %>% as_tibble()
#-------------------------------------------------------------------------#
...
dt_04<-read.csv2(here::here(directori_dades,"04.csv"),sep=";",dec=",",header = TRUE,
                 stringsAsFactors=F) %>% as_tibble()
...
dt_cataleg2<-readxl::read_excel(conductor_codis2,col_types = "text")%>%select(cod,agr,agr2,agr3,agr4,agr5,agr6,agr7,agrCVD)
