...
dt_plana_covid1_agr$Ad_UCI<-
  ifelse(is.na(dt_plana_covid1_agr$F_ENTRADA_UC.ICU_DATE_IN),"No","Si" )

# FER-HO 16:00 17:30!.6.7.2020

dt_plana_covid1_agr$EDAD.AGE2<-
  ifelse(dt_plana_covid1_agr$EDAD.AGE<=65,"<=65 años",">65 años")

dt_plana_covid1_agr$EDAD.AGE3<-
  ifelse(dt_plana_covid1_agr$EDAD.AGE<=55,"<=55 años",">55 años")
...
dt_plana_covid1_agr_lab<-factoritzar.NO.YES(dt_plana_covid1_agr,"factor",conductor)
...
dt_plana_covid1_agr_exc_lab<-factoritzar.NO.YES(dt_plana_covid1_agr_exc,"factor",conductor)
...
dt_plana_covid2_agr3<-factoritzar.NO.YES(dt_plana_covid2_agr2,"factor",conductor)
...
dt_plana_covid2_agr_b_3<-factoritzar.NO.YES(dt_plana_covid2_agr_b_2,"factor",conductor)
...
dt_plana_covid3_agr3<-factoritzar.NO.YES(dt_plana_covid3_agr2,"factor",conductor)
...
#
dt_plana_covid4_agr3_exc<-factoritzar.NO.YES(dt_plana_covid4_agr3_exc,"factor",conductor)
...
dt_plana_covid1_agr_exc2_lab2$SEXO.SEX<- relevel(dt_plana_covid1_agr_exc2_lab2$SEXO.SEX, ref = "Mujer")
...
#i)
mylogit <- glm(Death2 ~ SEXO.SEX + EDAD.AGE + DIAB, data = dt_plana_covid1_agr_exc2_lab2, family = "binomial")
PP1A<-summary(mylogit)
PP1B<-exp(cbind(OR = coef(mylogit), confint(mylogit)))


PP1C<-tab_model(mylogit)

#KK<-table1( ~ SEXO.SEX + EDAD.AGE + DIAB, data = dt_plana_covid1_agr_exc2_lab2| Death2, data=dt_plana_covid1_agr_exc2_lab2)
#ib)
mylogitb <- glm(Death2 ~ SEXO.SEX + agecat + DIAB+DG.HTA+DG.OB+DG.Hyperlip, data = dt_plana_covid1_agr_exc2_lab2, family = "binomial")
PP2A<-summary(mylogitb)
PP2B<-exp(cbind(OR = coef(mylogitb), confint(mylogitb)))
#ic)
mylogitc <- glm(Death2 ~ SEXO.SEX + EDAD.AGE3 + DIAB+DG.HTA+DG.OB+DG.Hyperlip, data = dt_plana_covid1_agr_exc2_lab2, family = "binomial")
PP3A<-summary(mylogitc)
PP3B<-exp(cbind(OR = coef(mylogitc), confint(mylogitc)))
#ii)
mylogit2 <- glm(Death2 ~ SEXO.SEX + EDAD.AGE2 + DIAB+DG.HTA+DG.OB+DG.Hyperlip, data = dt_plana_covid1_agr_exc2_lab2, family = "binomial")
PP4A<-summary(mylogit2)
PP4B<-exp(cbind(OR = coef(mylogit2), confint(mylogit2)))
#iii)
mylogit3 <- glm(Ad_UCI ~  SEXO.SEX + EDAD.AGE + DIAB+DG.HTA+DG.OB+DG.Hyperlip, data = dt_plana_covid1_agr_exc2_lab2, family = "binomial")
PP5A<-summary(mylogit3)
PP5B<-exp(cbind(OR = coef(mylogit3), confint(mylogit3)))
#iv)
mylogit4 <- glm(Ad_UCI ~ SEXO.SEX + EDAD.AGE2 + DIAB+DG.HTA+DG.OB+DG.Hyperlip, data = dt_plana_covid1_agr_exc2_lab2, family = "binomial")
PP6A<-summary(mylogit4)
PP6B<-exp(cbind(OR = coef(mylogit4), confint(mylogit4)))
```
