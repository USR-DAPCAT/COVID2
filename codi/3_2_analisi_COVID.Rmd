...
criteris_exclusio_diagrama(dt=dt_plana_covid1_agr_lab,
                                        taulavariables=conductor,
                                        criteris = "exc_pre",
                                        ordre="exc_ordre",
                                        grups=NA,
...
## Reetiquetar
dades<-etiquetar(dades,taulavariables=conductor, camp_descripcio = "descripcio")
...
formula<-formula.text("Taula01",y="DIAB",taulavariables = conductor,dt=dt_plana_covid1_agr_exc) 
...
table1::table1(~EDAD.AGE|DIAB, 
               data = dt_plana_covid1_agr_exc_lab,overall="Total",caption="Taula 1a",
...
formula<-formula.text("Taula01B",y="DIAB",taulavariables = conductor,dt=dt_plana_covid1_agr_exc_lab2) 
...
table1::table1(~EDAD.AGE|DIAB, 
               data = dt_plana_covid1_agr_exc_lab2,caption="Taula 1b",
               render.continuous=c(.="Mean (SD)", .="Median [Q1, Q3]"))
...
formula<-formula.text("Taula05",y="DIAB",taulavariables = conductor,dt=dt_plana_covid5_6_agr2_exc2)
...
formula<-formula.text("Taula05B",y="DIAB",taulavariables = conductor,dt=dt_plana_covid5_6_agr_exc2)
...
formula<-formula.text("Taula03",y="DIAB",taulavariables = conductor,dt=dt_plana_covid3_agr3_exc)
...
formula<-formula_table1("Taula03",y="DIAB",taulavariables = conductor,dt=dt_plana_covid3_agr3_exc) 
table1::table1(formula, 
               data = dt_plana_covid3_agr3_exc,caption="**TABLA 3.Registros de las constantes vitales  durante el ingreso(no se recogen las de UCI),con la función!.**",
               render.continuous=c(.="Mean (SD)", .="Median [Q1, Q3]"))
...
formula<-formula.text("Taula04",y="DIAB",taulavariables = conductor,dt=dt_plana_covid4_agr3_exc)
...
formula<-formula_table1("Taula04",y="DIAB",taulavariables = conductor,dt=dt_plana_covid4_agr3_exc) 
table1::table1(formula, 
               data = dt_plana_covid4_agr3_exc,caption="**TABLA 4. Registros de los resultados de peticiones de laboratorio realizadas durante el ingreso,con la función!.**",
               render.continuous=c(.="Mean (SD)", .="Median [Q1, Q3]"))
...
formula<-formula.text("Taula02",y="DIAB",taulavariables = conductor,dt = dt_plana_covid2_agr_exc2 )
...
formula<-formula.text("Taula02B",y="DIAB",taulavariables = conductor,dt = dt_plana_covid2_agr_b_exc2)

T02B<-descrTable(formula,
                method =2,
                Q1 = 0, Q3 = 1,
...
formula<-formula.text("Taula08",y="DIAB",taulavariables = conductor,dt = dt_plana_covid1_agr_exc2_lab)
...
formula<-formula.text("Taula08",y="SEXO.SEX",taulavariables = conductor,dt = dt_plana_covid1_agr_exc2_DIAB_lab)
descrTable(formula,
                         method =2,
                         Q1 = 0, Q3 = 1,
...
formula<-formula.text("Taula08",y="EDAD.AGE2",taulavariables = conductor,dt = dt_plana_covid1_agr_exc2_DIAB_lab)
descrTable(formula,                            
                         method =2,
                         Q1 = 0, Q3 = 1,
                         data=dt_plana_covid1_agr_exc2_DIAB_lab,
...
formula<-formula.text("Taula08",y="EDAD.AGE2",taulavariables = conductor,dt = dt_plana_covid1_agr_exc2_NO_DIAB_lab)
...
M1_Exitus<-formula.text("ajuste7","Death2",taulavariables = conductor,dt=dades)%>% 
  glm(data = dades, family = "binomial") 

M2_VM<-formula.text("ajuste7","Death_DG.Mechanical_ventialtion=='Si'",taulavariables = conductor,dt=dades)%>% 
  glm(data = dades, family = "binomial") 
...
c("ajuste1","ajuste2","ajuste3","ajuste4","ajuste5","ajuste6","ajuste7","ajuste8") %>% 
  map(~formula.text(x=.x,"Death2",taulavariables = conductor,dt=dades)) %>% 
  map(~glm(formula=.x,data = dades, family = "binomial")) %>% 
...
formula.text("ajuste7","Death2",taulavariables = conductor,dt=dades) %>% 
  glm(data = dades, family = "binomial") %>% 
...
formula.text("ajuste7","Death_DG.Mechanical_ventialtion=='Si'",taulavariables = conductor,dt=dades) %>% 
  glm(data = dades, family = "binomial") %>% 
  parameters::model_parameters(exponentiate = TRUE) %>% 
  filter(Parameter!="(Intercept)") %>% 
  etiquetar_taula(camp="Parameter",taulavariables = conductor,camp_descripcio = "desc_model",idcamp = "camp2")  %>% 
